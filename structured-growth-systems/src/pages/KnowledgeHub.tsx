  ...
  return (
    <div className="w-full pt-32  px-6 max-w-7xl mx-auto">
      ...
      <div className="grid lg:grid-cols-3 gap-8 mb-40">
        {clusters.map((cluster, i) => (
          ...
          >
            ...
            <Link to="/blog" className="text-sm font-bold flex items-center gap-2 text-white hover:text-brand-orange transition-colors">
      ...
      <section className="mb-40">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="p-10 rounded-3xl bg-white/5 border border-white/10">
            ...
            <Link to="/case-studies/ecommerce-scaling" className="text-brand-orange font-bold flex items-center gap-2">
          ...
          <div className="p-10 rounded-3xl bg-white/5 border border-white/10">
            ...
            <Link to="/insights" className="text-brand-orange font-bold flex items-center gap-2">
      ...
      <div className="flex flex-col md:flex-row gap-6 justify-center">
        <Link to="/audit" className="btn-glow px-8 py-4 bg-brand-orange text-white rounded-full font-bold text-center">
          Get a Strategic Audit
        </Link>
        <Link to="/architecture" className="px-8 py-4 rounded-full border border-white/10 bg-white/5 text-white font-bold text-center hover:bg-white/10 transition-colors">
