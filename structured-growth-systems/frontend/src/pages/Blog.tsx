        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <div className="max-w-2xl mx-auto flex flex-col sm:flex-row gap-4 mb-12">
              ...
              <Link to="/work-with-me" className="btn-premium px-8 py-4 whitespace-nowrap">
      ...
      <section className="px-6 mb-32">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-12">
            ...
            <Link to="#" className="text-brand-orange text-sm font-bold flex items-center gap-2 hover:underline">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              {popularGuides.map((guide, i) => (
                <div key={i} className="p-8 rounded-2xl animated-border-card bg-black/40 border border-white/5 hover:border-brand-orange/30 transition-all group">
                  ...
                  <Link to="#" className="text-brand-orange text-sm font-bold flex items-center gap-2 group-hover:gap-4 transition-all">
