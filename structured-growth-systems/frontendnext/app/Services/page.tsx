        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <Link href="/contact" className="btn-premium px-12 py-6 text-xl group w-full sm:w-auto">
      ...
      <footer className="py-32 px-6">
        <div className="max-w-7xl mx-auto p-16 md:p-24 rounded-[40px] bg-gradient-to-br from-brand-orange to-orange-700 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <Link href="/contact" className="px-12 py-6 rounded-xl bg-white text-black text-2xl font-bold hover:bg-black hover:text-white transition-all inline-flex items-center gap-3">
