        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link href="/contact" className="btn-glow group relative px-8 py-4 bg-brand-orange text-black rounded-full font-bold text-lg overflow-hidden flex items-center justify-center gap-2 transition-transform hover:scale-105">
                <span className="relative z-10">Apply for Strategy Call</span>
                <ArrowRight className="relative z-10 w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Link>
              <Link href="/CaseStudies" className="px-8 py-4 bg-white/5 border border-white/10 hover:bg-white/10 text-white rounded-full font-bold text-lg flex items-center justify-center gap-2 transition-all">
                View Case Studies
              </Link>
            </div>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <Link href="/contact" className="flex items-center gap-2 text-brand-orange font-bold group/link">
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex justify-between items-end mb-16">
            ...
            <Link href="/CaseStudies" className="hidden md:flex items-center gap-2 text-brand-orange hover:text-yellow-300 font-medium group">
            ...
            {[
              ...
              >
                <TiltCard className="group h-full">
                  <Link href={`/CaseStudies/${caseStudy.id}`} className="block h-full p-1 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/[0.08] transition-colors overflow-hidden">
          ...
          <div className="mt-12 text-center md:hidden">
            <Link href="/case-studies" className="inline-flex items-center gap-2 text-brand-orange font-medium">
   ...
   {/* LATEST FROM THE JOURNAL */}
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-8">
            ...
            <Link href="/blog" className="group flex items-center gap-3 text-white/60 hover:text-brand-orange transition-colors font-bold text-lg">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
              <Link href="/contact" className="btn-premium px-10 py-5 text-lg group w-full sm:w-auto">
                Book Strategy Call
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Link>
              <Link href="/nexzen" className="px-10 py-5 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-all text-lg font-bold w-full sm:w-auto">
      ...
      <section className="py-40 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <Link href="/contact" className="btn-glow inline-flex items-center gap-3 px-10 py-5 bg-brand-orange text-black rounded-full font-bold text-xl hover:scale-105 transition-transform">
