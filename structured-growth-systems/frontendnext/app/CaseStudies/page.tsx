...
export const caseStudies = [
  {
    id: 1,
    bigMetric: <><span className="text-brand-orange">+312%</span> Revenue Growth in <span className="text-brand-orange">6</span> Months</>,
  ...
  {
    id: 2,
    bigMetric: <><span className="text-brand-orange">43%</span> Reduction in Cost Per Qualified Lead</>,
  ...
  {
    id: 3,
    bigMetric: <><span className="text-brand-orange">£1.1M</span> Revenue Added Across <span className="text-brand-orange">2</span> Markets</>,
  ...
  {
    id: 4,
    bigMetric: <>ROAS Increased from <span className="text-brand-orange">1.6x</span> to <span className="text-brand-orange">3.8x</span> in <span className="text-brand-orange">60</span> Days</>,
  ...
  {
    id: 5,
    bigMetric: <><span className="text-brand-orange">$420K</span> Generated in <span className="text-brand-orange">14</span> Days</>,
  ...
  {
    id: 6,
    bigMetric: <><span className="text-brand-orange">+286%</span> Increase in Qualified Leads</>,
  ...
  return (
    <div className="w-full pt-32 pb-40 px-6 max-w-7xl mx-auto">
      <div className="max-w-3xl mb-20">
        <h1 className="text-5xl md:text-7xl font-display font-bold mb-6"><span className='text-brand-orange'>NEX</span>Zen</h1>
        <h1 className="text-5xl md:text-7xl font-display font-bold mb-6">Case Studies</h1>
        <p className="text-xl text-white/60">
         <span className='text-brand-orange'>Real Numbers</span>. Documented strategies. See how structured growth systems perform in the wild across different industries and markets.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
        {caseStudies.map((study, i) => (
          ...
          >
            <Link href={`/CaseStudies/${study.id}`} className="group block h-full flex flex-col">
              ...
              <div className="flex-grow flex flex-col">
                ...
                <div className="flex flex-wrap gap-3 mb-6">
                  {Object.entries(study.metrics).map(([key, val]) => (
                    <div key={key} className="px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-mono text-brand-orange uppercase tracking-wider">
                      <span className="text-white/40 mr-2">{key}:</span>{val}
                    </div>
                  ))}
                </div>
                <div className="flex items-center gap-2 text-sm font-bold text-white group-hover:text-brand-orange transition-colors mt-auto">
